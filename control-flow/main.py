...
age = int(input("Enter dog's age in human years to find out how old it is in dog years: "))
if age <= 2:
    dog_age = age * 10
else:
    dog_age = (age * 7) + 6
...
tri_a = int(input('Triangle length a: '))
tri_b = int(input('Triangle length b: '))
tri_c = int(input('Triangle length c: '))
tri_type = None
if(tri_a == tri_b and tri_c == tri_a):
    tri_type = 'equilateral'
if((tri_a == tri_b and tri_a != tri_c) and (tri_b == tri_c and tri_c != tri_a) and (tri_a == tri_c and tri_a != tri_b)):
    tri_type = 'isosceles'
if(tri_a != tri_b and tri_a != tri_c):
    tri_type = 'scalene'
print(f'A triangle with sides of {tri_a}, {tri_b} & {tri_c} is a {tri_type} triangle')
